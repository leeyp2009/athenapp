...
void StoppingTime(MeshBlock *pmb, const Real time, const AthenaArray<Real> &prim,
     AthenaArray<Real> &stopping_time_array);
...
if (nPlanet==2){
  ...
  restart          = pin->GetOrAddInteger("problem","restart",0);
